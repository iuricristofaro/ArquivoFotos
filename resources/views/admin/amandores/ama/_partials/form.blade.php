    <div class="w-full bg-white shadow-md rounded px-8 py-12">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="titulo" class="form-control" id="exampleFormControlInput1" value="{{ $infra->titulo ?? old('titulo') }}">
        </div>
        <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label">Texto</label>
            <input type="text" name="texto" class="form-control" id="exampleFormControlInput1" value="{{ $infra->texto ?? old('texto') }}">
        </div>
        <div class="mb-3">
